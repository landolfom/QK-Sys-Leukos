...
def delete_all_searched_rows(df, column_name):
    ...
    if delete_button == True and len(value) > 0:
        ...
        if NEIN_button:
            st.success("Parameter werden NICHT gelöscht und verbleiben im System. (Falls Sie die Daten doch löschen möchten, muss zuerst die 'Gefundene Daten löschen' Taste erneut angeklickt werden)")
        return df               
