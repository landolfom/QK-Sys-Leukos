...
with tab5:
    ...
    with st.expander('Suche Parameter mit Datum/Zeit'):
        ...
        if search_button:
            st.session_state['search_button_state'] = True
        ...
        if st.session_state['search_button_state']:
            ...
            if delete_button:    
                st.session_state['delete_button_state'] = True
            ...
            if st.session_state['delete_button_state']:
                ...
                if len(value) == 0:
                    ...
                    if JA_button:
                        ...
                        st.text('Um das Löschen zu vervollständigen, untenstehenden Schaltfläche anklicken.')
